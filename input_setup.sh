...
INPUT_TRUNK_TOKEN=${INPUT_TRUNK_TOKEN}
TRUNK_TOKEN=${INPUT_TRUNK_TOKEN}
GITHUB_EVENT_PULL_REQUEST_BASE_SHA=$(githubEventPR pull_request.base.sha)
GITHUB_EVENT_PULL_REQUEST_HEAD_REPO_FORK=$(githubEventPR pull_request.head.repo.fork)
GITHUB_EVENT_PULL_REQUEST_HEAD_SHA=$(githubEventPR pull_request.head.sha)
GITHUB_EVENT_PULL_REQUEST_NUMBER=$(githubEventPR pull_request.number)
